...
The public API lives at the module root (`github.com/go-ruby-fast-gettext-locale/fast-gettext-locale`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `fast-gettext-locale`, while the surface follows
...
```go
import "github.com/go-ruby-fast-gettext-locale/fast-gettext-locale"
```
...
- **[pkg.go.dev/github.com/go-ruby-fast-gettext-locale/fast-gettext-locale](https://pkg.go.dev/github.com/go-ruby-fast-gettext-locale/fast-gettext-locale)**

The module's [README](https://github.com/go-ruby-fast-gettext-locale/fast-gettext-locale#readme) carries worked
