# go-ruby-fast-gettext-locale documentation

**Pure-Go fast_gettext locale handling — tag parsing and Accept-Language negotiation (CGO=0).**

`go-ruby-fast-gettext-locale/fast-gettext-locale` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `fast-gettext-locale`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-fast-gettext-locale/fast-gettext-locale`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `fast-gettext-locale`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-fast-gettext-locale/fast-gettext-locale
```
...
| [`docs`](https://github.com/go-ruby-fast-gettext-locale/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-fast-gettext-locale.github.io`](https://github.com/go-ruby-fast-gettext-locale/go-ruby-fast-gettext-locale.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-fast-gettext-locale/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-fast-gettext-locale/fast-gettext-locale](https://github.com/go-ruby-fast-gettext-locale/fast-gettext-locale).
